...
In order to run the file it must first be complied, which is done with the makefile. To do this on Linux, go to the directory containing the makefile, hexdump.o and print.c and print.h files, then enter the following command into the terminal:
	./make
